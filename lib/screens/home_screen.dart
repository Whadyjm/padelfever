...
class _HomeScreenState extends State<HomeScreen> {
        ...
        children:[
          Scaffold(
            ...
            appBar: AppBar(
              actions: [
                currentUser != null ?
                Text('${currentUser.email?.substring(0, 14)}', style: AppText.smallTextStyle(Colors.white),):IconButton(
                ...
                currentUser != null ? IconButton(onPressed: (){
                  FirebaseAuth.instance.signOut(); setState(() {
                });} , icon: Icon(Icons.logout_rounded, size: 30, color: Colors.white,)) : const SizedBox.shrink(),
                const SizedBox(width: 10,),
                IconButton(
                  onPressed:
                      () => Navigator.push(
  ...
  Future<void> authProcess(setState, BuildContext context, BtnProvider btnProvider) async {
    setState(() {
      _isLoading = true;
    });
